...
const renderCountryResult = (country: Country) => {
    ...
    const capital = result.querySelector('.result__capital') as HTMLParagraphElement;
    const languages = result.querySelector('.result__languages') as HTMLUListElement;
    const currencies = result.querySelector('.result__currencies') as HTMLUListElement;
